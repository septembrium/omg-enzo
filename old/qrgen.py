...
# Wed Jul 25
# Datbase: [TODO] make more normalized and flexible
# - id
# - slug
# - question
# - comp1
...
# + qrfilename
# + qrfilename
# [TODO] refactor to use database plugin so the database connection
# doesn't have to be created in every handler function
import bottle
...
# [TODO]check if database(file) is there
