...
class QRCodeMaker():
    '''
    makes QRCodes on the filesystem and creates mathing database records
    '''
    def __init__(self, path, qr_type_number, error_correct_level):
        self.path = path
        self.qr_type_number = qr_type_number
        self.error_correct_level = error_correct_level

    def create_qrcode_file(text, img_type, path, name, qr_type_number, error_correct_level):
    ...
    def create_qrcode_record(author_id, content, eclevel, qrtypenumber,\
